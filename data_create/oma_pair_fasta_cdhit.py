    ...
    with open(orthologous_groups_file, 'r') as file:
        for line in file:
            ...
            if group_number in selected_groups:  # 選択されたグループのみ処理
                ...
                ids = [id for id in parts[1:] if id[:5] in species_list]
                if len(ids) > 1:
...
oma_group_file = '/home/aca10223gf/workplace/data/OMA_database/oma-groups.cdhit_80_sorted.txt' # OMAgroupと配列IDのファイル
...
train_output_dir = '/home/aca10223gf/workplace/data/OMA_database/cdhit_80/train_fasta'  # トレーニングデータ出力ディレクトリ
test_output_dir = '/home/aca10223gf/workplace/data/OMA_database/cdhit_80/test_fasta'  # テストデータ出力ディレクトリ
