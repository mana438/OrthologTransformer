...
oma_group_file = '/gs/bs/tgh-24IAU/akiyama/data/OMA_database/oma-groups.cdhit_80_sorted.txt' # OMAgroupと配列IDのファイル
...
train_output_dir = '/gs/bs/tgh-24IAU/akiyama/data/OMA_database/cdhit_80/train_fasta'  # トレーニングデータ出力ディレクトリ
test_output_dir = '/gs/bs/tgh-24IAU/akiyama/data/OMA_database/cdhit_80/test_fasta'  # テストデータ出力ディレクトリ
